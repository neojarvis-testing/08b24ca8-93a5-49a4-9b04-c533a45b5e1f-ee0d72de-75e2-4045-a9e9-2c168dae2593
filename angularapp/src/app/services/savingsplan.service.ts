...
//     return this.http.get<SavingsPlan[]>(this.apiUrl, { headers: this.getAuthHeaders() });
//   }
...
//     const url = `${this.apiUrl}/${savingsPlanId}`;
...
export class SavingsplanService {
  ...
  getAllSavingsPlans(): Observable<SavingsPlan[]> {
    return this.http.get<SavingsPlan[]>(`${this.apiUrl}/api/SavingsPlan`);
  }
  ...
  addSavingsPlan(requestObject: SavingsPlan): Observable<SavingsPlan> {
    return this.http.post<SavingsPlan>(`${this.apiUrl}/api/SavingsPlan`, requestObject, {
